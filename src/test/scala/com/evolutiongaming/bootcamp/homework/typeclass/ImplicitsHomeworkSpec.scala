...
import com.evolutiongaming.bootcamp.homework.typeclass.ImplicitsHomework.MyTwitter.{FbiNote, Twit, createTwitCache}
import com.evolutiongaming.bootcamp.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.instances._
import com.evolutiongaming.bootcamp.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.syntax.GetSizeScoreOps
import com.evolutiongaming.bootcamp.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.{GetSizeScore, MutableBoundedCache, PackedMultiMap, SizeScore}
import com.evolutiongaming.bootcamp.homework.typeclass.ImplicitsHomeworkSpec.TestValue
import com.evolutiongaming.bootcamp.homework.typeclass.ImplicitsHomeworkSpec.TestValue.testValueGetSizeScore
...
class ImplicitsHomeworkSpec extends AnyFreeSpec with Matchers {
    ...
    "Iterate2 instances provided" - {
        "for Map" in {
            assertCompiles(
                """import com.evolutiongaming.bootcamp.homework.typeclass.ImplicitsHomework.SuperVipCollections4s._
                  |import com.evolutiongaming.bootcamp.homework.typeclass.ImplicitsHomework.SuperVipCollections4s.instances._
                  |
